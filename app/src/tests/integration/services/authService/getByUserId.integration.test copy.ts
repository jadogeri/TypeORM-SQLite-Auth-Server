...
describe('getByUserId() getByUserId method', () => {
  ...
  describe('Happy Paths', () => {
    ...
    it('should return an Auth object when a valid userId is provided and record exists', async () => {
      ...
      jest.mocked(authRepository.findOne).mockResolvedValue(mockAuth as any);
  ...
  describe('Edge Cases', () => {
    ...
    it('should return null when no Auth record is found for the given userId', async () => {
      // This test ensures that the function returns null when no record is found.
      jest.mocked(authRepository.findOne).mockResolvedValue(null as any);
    ...
    it('should throw an error if the repository throws an error', async () => {
      ...
      jest.mocked(authRepository.findOne).mockRejectedValue(error as never);
